...
export class CustomerserviceService {
  ...
  getACustomer(customerID: any): Observable<Customer> {
    return this.http
      .get<Customer>(this.resturl + '/getCus/' + customerID+'/')
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  getCustomer(email: any): Observable<Customer> {
    return this.http
      .get<Customer>(this.resturl + '/signCus/' + email +'/')
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteCustomer(customerID: any): Observable<Customer> {
    return this.http
      .delete<Customer>(this.resturl + '/deleteCus/' + customerID, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
